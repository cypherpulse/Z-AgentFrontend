...
export function ProfileChat({ profile }: ProfileChatProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await askProfileAi({ question: input, profile });
        ...
        <div className="bg-background border rounded-lg overflow-hidden">
          ...
          <div className="flex items-center gap-3 p-4 border-b bg-muted/30">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Profile analysis assistant</p>
            </div>
          </div>
            ...
            {messages.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground">
                  Ask me anything about this profile's coins, holdings, or creator info!
                </p>
              </div>
            )}
