        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-full max-w-[85vw] sm:max-w-[400px] border-l-2 border-primary-200 dark:border-primary-800 p-0 h-full max-h-[100vh]">
                <div className="flex flex-col h-full max-h-[100vh]">
                  <SheetHeader className="border-b border-primary-200 dark:border-primary-800 pb-4 px-6 pt-6 flex-shrink-0">
                  ...
                  <div className="flex-1 overflow-y-auto min-h-0">
                    <div className="flex flex-col gap-2 p-6">
                      ...
                      {navLinks.map((link) => (
                        <Link key={link.href} href={link.href}>
                          <div
                            className={`px-4 py-4 rounded-lg text-base font-medium transition-all cursor-pointer border-2 min-h-[48px] flex items-center ${
                              location === link.href
                    ...
                    {/* Mobile Actions */}
                    <div className="border-t-2 border-primary-200 dark:border-primary-800 p-6 space-y-4 flex-shrink-0">
